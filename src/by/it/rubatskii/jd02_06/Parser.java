...
class Parser {
    ...
    Var calculateExpression(String expression) throws CalculationException {
    ...
    private String simplifyExpression(String expression) throws CalculationException {
    ...
    private Var calculateOperation(String strLeft, String strRight, String operation) throws CalculationException {
